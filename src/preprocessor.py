...
class Preprocessor:
    ...
    def _truncate_label(text: str, max_text_len: int) -> str:
        """
        Function ctc_loss can't compute loss if it can't find a mapping between text label and input labels.
    ...
    def _simulate_text_line(self, batch: Batch) -> Batch:
        ...
        for i in range(batch.batch_size):
            ...
            # Concatinating ground truth texts
            ...
            # Putting all selected word images into target image
    ...
    def process_img(self, img: np.ndarray) -> np.ndarray:
        ...
        if self.data_augmentation:
            ...
            # Mapping image into target image

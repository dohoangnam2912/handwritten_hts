...
class DataLoaderIAM:
    """
    Loading data which corresponds to IAM format
    """
    ...
    def __init__(self,
        ...
        for line in f:
            ...
            # Filename: part1-part2-part3 --> part1/part1 - part2/part1 - part2 - part2.png
        ...
        # Splitting into traning and validation set: 95% - 5%
    ...
    def train_set(self) -> None:
        """
        Switching to randomly chosen subset of training set
        """
    ...
    def get_next(self) -> Batch:
        ...
        gt_texts = [self.samples[i] for i in batch_range]
